...
const Footer = () => {
    return (
        <footer className='bg-[#f3f6fa]'>
                ...
                <div className='w-4/12 lg:w-full lg:mt-6'>
                    <div className='w-full flex flex-col justify-start gap-5'>
                        ...
                        <div className='h-[50px] w-full bg-white border relative'>
                            ...
                            />
                            <button className='h-full absolute right-0 bg-[#059473] text-white uppercase px-4 
                            font-bold text-sm'>Subscribe</button>
                        </div>
            ...
            <div className='w-[90%] flex-wrap justify-center items-center text-slate-600 mx-auto py-5 text-center'>
                <span className=''>Copiright @ 2024 All Rights Reserved</span>
            </div>
        </footer>
    );
};
