        ...
        const obj = [
            {
                ...
                price: quantity * (product.price - Math.floor((price * 5) / 100)),
                products: [
                    {
                        quantity,
                        productInfo: product
                        ...
                        <div className='flex flex-col gap-5'>
                            ...
                            <div className='flex gap-3 pb-10 border-b'>
                                ...
                                <div>
                                    ...
                                    >
                                        <span className='text-white'><FaHeart /></span>
                                    </button>
                                </div>
                            </div>
                            ...
                            <div className='flex py-5 gap-5'>
                                ...
                                <div className='flex flex-col gap-5'>
                                    ...
                                    <ul className='flex justify-start items-center gap-3'>
                                        ...
                                        <li>
                                            <a
                                                className='w-[38px] h-[38px] hover:bg-[#059473] hover:text-white flex 
                                                justify-center items-center bg-cyan-500 rounded-full text-white'
                                                href='#'
                                            >
                                                <FaTwitter />
                                            </a>
                                        ...
                                        <li>
                                            <a
                                                className='w-[38px] h-[38px] hover:bg-[#059473] hover:text-white flex 
                                                justify-center items-center bg-purple-500 rounded-full text-white'
                                                href='#'
                                            >
                                                <FaLinkedin />
                                            </a>
                                        ...
                                        <li>
                                            <a
                                                className='w-[38px] h-[38px] hover:bg-[#059473] hover:text-white flex 
                                                justify-center items-center bg-slate-800 rounded-full text-white'
                                                href='#'
                                            >
                                                <FaGithub />
                                            </a>
                            ...
                            <div className='flex gap-3'>
                                {
                                    product.stock ?
                                        ...
                                        onClick={buynow}
                                        className='px-8 py-3 h-[50px] cursor-pointer hover:shadow-lg 
                                        hover:shadow-green-500/40 bg-[#36dab3] text-white'>
                                            Buy Now
                                        </button> : ''
                                }
                                <Link
                                    to='#'
                                    className='px-8 py-3 h-[50px] cursor-pointer hover:shadow-lg 
                                    hover:shadow-red-500/40 bg-red-500 text-white'
                                >
                                    Chat Seller
                                </Link>
                            </div>
                            ...
                            <div className='pr-4 md-lg:pr-0'>
                                <div className='grid grid-cols-2'>
                                    <button
                                        ...
                                        className={`py-1 hover:text-white px-5 hover:bg-[#059473] ${state === 'reviews' ? 'bg-[#059473] text-white' : 'bg-slate-200 text-slate-700'} rounded-sm`}
                                    >
                                        Reviews
                                    </button>
                                    <button
                                        onClick={() => setState('description')}
                                        className={`py-1 hover:text-white px-5 hover:bg-[#059473] ${state === 'description' ? 'bg-[#059473] text-white' : 'bg-slate-200 text-slate-700'} rounded-sm`}
                                    >
                                        Description
                                    </button>
                                </div>
            ...
            <section>
                <div className='w-[85%] md:w-[80%] sm:w-[90%] lg:w-[90%] h-full mx-auto'>
                    ...
                    <div className='w-full flex justify-center items-center py-8'>
                        {/* custom_bullet classe do swiper declarada na pagination! */}
