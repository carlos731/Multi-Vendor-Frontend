...
import { placer_order } from '../store/reducers/orderReducer';
                                ...
                                <div className='bg-white p-6 shadow-sm rounded-md'>
                                            ...
                                            <form onSubmit={save}>
                                                <div className='flex md:flex-col md:gap-2 w-full gap-5 text-slate-600'>
                                                    ...
                                                    <div className='flex flex-col gap-1 mb-2 w-full'>
                                                        ...
                                                        <input
                                                            onChange={inputHandle} value={state.address}
                                                            className='w-full px-3 py-2 border border-slate-200 outline-none 
                                                            focus:border-green-500 rounded-md'
                                                ...
                                                <div className='flex md:flex-col md:gap-2 w-full gap-5 text-slate-600'>
                                                    <div className='flex flex-col gap-1 mb-2 w-full'>
                                                        ...
                                                        <input
                                                            onChange={inputHandle} value={state.phone}
                                                            className='w-full px-3 py-2 border border-slate-200 outline-none 
                                                            focus:border-green-500 rounded-md'
                                                    ...
                                                    <div className='flex flex-col gap-1 mb-2 w-full'>
                                                        ...
                                                        <input
                                                            onChange={inputHandle} value={state.post}
                                                            className='w-full px-3 py-2 border border-slate-200 outline-none 
                                                            focus:border-green-500 rounded-md'
                                                            type='text' name='post' id='post' placeholder='Post'
                                                        />
                                                    </div>
                                                </div>
                                                ...
                                                <div className='flex md:flex-col md:gap-2 w-full gap-5 text-slate-600'>
                                                    <div className='flex flex-col gap-1 mb-2 w-full'>
                                                        ...
                                                        <input
                                                            onChange={inputHandle} value={state.province}
                                                            className='w-full px-3 py-2 border border-slate-200 outline-none 
                                                            focus:border-green-500 rounded-md'
                                                            type='text' name='province' id='province' placeholder='Province'
                                                        />
                                                    </div>
                                                    ...
                                                    <div className='flex flex-col gap-1 mb-2 w-full'>
                                                        ...
                                                        <input
                                                            onChange={inputHandle} value={state.city}
                                                            className='w-full px-3 py-2 border border-slate-200 outline-none 
                                                            focus:border-green-500 rounded-md'
                                                ...
                                                <div className='flex md:flex-col md:gap-2 w-full gap-5 text-slate-600'>
                                                    <div className='flex flex-col gap-1 mb-2 w-full'>
                                                        ...
                                                        <input
                                                            onChange={inputHandle} value={state.area}
                                                            className='w-full px-3 py-2 border border-slate-200 outline-none 
                                                            focus:border-green-500 rounded-md'
                                                    ...
                                                    <div className='flex flex-col gap-1 mt-7 mb-2 w-full'>
                                                        <button
                                                            className='px-3 py-[6px] rounded-sm hover:shadow-green-500/50 
...

                                    {
                                        ...
                                        <div className='flex flex-col gap-1'>
                                            ...
                                            <p>
                                                <span className='bg-blue-200 text-blue-800 text-sm font-medium mr-2 px-2 py-1 rounded cursor-default'>Home</span>
                                            ...
                                            <p className='text-slate-600 text-sm'>Email To carlos@gmail.com</p>
                                        </div>
                                    }
                                </div>
                                                    ...
                                                    <div className='w-full flex flex-wrap'>
                                                        <div className='flex sm:w-full gap-2 w-7/12'>
                                                            <div className='flex gap-2 justify-start items-center'>
                                                                <img
                                                                    className='w-[80px] h-[80px]' src={pt.productInfo.images[0]} alt=""
                                                                />
                                                        ...
                                                        <div className='flex justify-between w-5/12 sm:w-full sm:mt-3'>
                                                            <div className='pl-4 sm:pl-0'>
                                                                {pt.productInfo.discount !== 0 && <h2 className='text-lg text-orange-500'>${pt.productInfo.price - Math.floor((pt.productInfo.price * pt.productInfo.discount) / 100)}</h2>}
                                                                <p className={`${pt.productInfo.discount !== 0 ? 'line-through' : 'text-orange-500'}`}>${pt.productInfo.price}</p>
                            ...
                            <div className='pl-3 md-lg:pl-0 md-lg:mt-5'>
                                <div className='bg-white p-3 text-slate-600 flex flex-col gap-3'>
                                    ...
                                    <button
                                        ...
                                        className={`px-5 py-[6px] rounded-sm ${res ? 'bg-red-500 hover:shadow-red-500/50 hover:shadow-lg' : 'bg-red-300'} text-sm text-white uppercase`}
                                    >
                                        Place Order
                                    </button>
                                </div>
